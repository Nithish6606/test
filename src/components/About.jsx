...
const aboutlst = [
  {
    name: <span className="text-blue-500 text-2xl">TechNova</span>,
    description:
  ...
  {
    name: <span className="text-blue-500 text-2xl">Haunted-Estate</span>,
    description:
  ...
  {
    name: <span className="text-blue-500 text-2xl">GenerAIze</span>,
    description:
    ...
    <section className="section  xl:min-h-[90vh]" id="about">
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-20 lg:flex-row justify-between items-start">
          <RevealRight>
            <div id="about1">
              <h2 className="text-4xl text-gradient max-w-sm mb-8 mx-auto lg:mx-0">About College</h2>
              ...
              <h2 className="text-4xl text-gradient max-w-sm mb-8 mx-auto lg:mx-0">About Department</h2>
              <p className="max-w-[455px]">
              ...
              <h2 className="text-4xl text-gradient max-w-sm mb-8 mx-auto lg:mx-0">About CreScencE</h2>
